...
patient_data = [[60, 'M', 160, 65, 78.0, 0.8, 0.7, 1, 1, 118, 62, 97, 154, 88, 37, 100, 12.6, 1, 0.5, 23, 14, 9, 0]]
# patient data en dataframe
patient_dataframe = pd.DataFrame(patient_data, columns=X_multi.columns)
#mettre la colonne sex avec label encoder
patient_df = pd.DataFrame(patient_data, columns=X_multi.columns)
patient_df['sex'] = LabelEncoder().fit(train_multi['sex']).transform(patient_df['sex'])
